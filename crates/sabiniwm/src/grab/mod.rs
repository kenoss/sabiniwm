...
impl SabiniwmState {
    ...
    pub(crate) fn grab_window_for_resize(
        &mut self,
        serial: smithay::utils::Serial,
        target: crate::focus::PointerFocusTarget,
        event: &smithay::input::pointer::ButtonEvent,
        ...
        let grab = WindowResizeGrab {
            release_condition,
            start_data,
            window_id: window.id(),
            left_top: window.geometry_actual().loc,
        };
